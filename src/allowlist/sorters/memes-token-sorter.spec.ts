...
describe('Simple tokensorter', () => {
  ...
  it('sorts total tokens consolidated', async () => {
    const sorter = new MemesTokenSorter({
      getConsolidatedUploadsForBlock: async (): Promise<
        ConsolidatedTdhInfo[]
      > => [
        {
          wallet: '0x1',
          boosted_memes_tdh: 2,
        } as unknown as ConsolidatedTdhInfo,
        {
          wallet: '0x2',
          boosted_memes_tdh: 1,
        } as unknown as ConsolidatedTdhInfo,
  ...
  it('sorts unique tokens consolidated', async () => {
    const sorter = new MemesTokenSorter({
      getConsolidatedUploadsForBlock: async (): Promise<
        ConsolidatedTdhInfo[]
      > => [
